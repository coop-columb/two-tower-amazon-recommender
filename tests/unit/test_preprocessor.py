...
class TestFeatureEngineer:
    ...
    def test_engineer_features_pipeline(self, feature_engineer, sample_data):
        ...
        text_cols = ["text_length", "word_count", "exclamation_count", "question_count", "caps_ratio"]
...
class TestAmazonReviewsPreprocessor:
    ...
    def sample_data(self):
        ...
        return pd.DataFrame({
            ...
            "text": ["This is a test review " * np.random.randint(1, 5) for _ in range(n_samples)],
    ...
    def test_process_pipeline(self, preprocessor, sample_data):
        ...
        expected_columns = [
            ...
            "item_review_count", "item_avg_rating", "item_rating_std",
        ]
